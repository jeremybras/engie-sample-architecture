...
import com.octo.archiexampleengie.repository.users.api.ApiUserRepository
import com.octo.archiexampleengie.repository.users.api.UserService
import com.octo.archiexampleengie.repository.users.db.DbUserRepository
...
class UserModule {
    ...
    fun provideUserPresenter(
        userView: UserView
    ): UserPresenter = UserPresenter(userView)
